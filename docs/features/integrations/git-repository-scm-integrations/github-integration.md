...
By default, the badge will test against the first [valid manifest file](../../../snyk-products/snyk-open-source/language-and-package-manager-support/) it detects in the root of your project.

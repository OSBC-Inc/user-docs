...
* If you are using a [Source code integration](../../integrations/git-repository-scm-integrations/):
  ...
  * Use [automated pull requests](broken-reference) when new fixes become available that help you to fix a vulnerability.
* If fixing node.js projects, you can run the [**snyk wizard**](broken-reference) CLI command.

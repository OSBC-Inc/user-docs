...
5. Add rules to the policy. [Click here for information on adding license rules](../../../snyk-products/snyk-open-source/license-policies/setting-a-license-policy.md) or [click here for information on adding security rules](../security-policies/how-to-create-a-security-policy-and-set-rules.md)

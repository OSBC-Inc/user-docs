...
This command does not manage the `.snyk` file that is part of your project. See the [`snyk policy`](broken-reference) and [`snyk ignore`](broken-reference) commands.

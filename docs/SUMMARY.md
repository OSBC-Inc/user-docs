...
* [시작하기](getting-started/README.md)
  * [Snyk 시작하기](getting-started/getting-started-snyk-products/README.md)
    ...
    * [Snyk 라이선스 컴플라이언스 관리 시작하기](getting-started/getting-started-snyk-products/getting-started-snyk-licensing-compliance.md)
    * [Snyk intel vulnerability DB](getting-started/getting-started-snyk-products/getting-started-snyk-intel-vuln-db-access.md)
...
* [Snyk Open Source](products/snyk-open-source/README.md)
  ...
  * [개발 언어 및 패키지 매니저 지원](products/snyk-open-source/language-and-package-manager-support/README.md)
  ...
  * [라이선스](products/snyk-open-source/licenses/README.md)
    * [Reports: 라이선스 탭](products/snyk-open-source/licenses/reports-licenses-tab.md)
  * [라이선스 정책](products/snyk-open-source/license-policies/README.md)
    * [라이선스 정책 설정](products/snyk-open-source/license-policies/setting-a-license-policy.md)
    * [라이선스 정책: 공동작업자가 보는 내용](products/snyk-open-source/license-policies/license-policies-what-collaborators-see.md)
  * [디펜던시 관리](products/snyk-open-source/dependency-management/README.md)
    * [자동 PR을 사용하여 디펜던시 업그레이드](products/snyk-open-source/dependency-management/upgrading-dependencies-with-automatic-prs.md)
* [Snyk Code](products/snyk-code/README.md)
  * [Use Cases](products/snyk-code/use-cases.md)
  * [주요 특징들](products/snyk-code/key-features/README.md)
    * [AI 엔진](products/snyk-code/key-features/ai-engine.md)
    * [사용자 경험](products/snyk-code/key-features/user-experience.md)
    * [통합](products/snyk-code/key-features/integrations.md)
  * [언어 및 프레임워크](products/snyk-code/snyk-code-language-and-framework-support.md)
  * [Snyk Code 구성](products/snyk-code/configuring-snyk-code.md)
  * [웹을 통해 Snyk Code 사용](products/snyk-code/using-snyk-code-web.md)
  * [IDE를 통해 Snyk Code 사용](products/snyk-code/using-snyk-code-via-ide.md)
  * [CLI를 통해 Snyk Code 사용](products/snyk-code/cli-for-snyk-code/README.md)
    * [Snyk Code CLI 결과 이해](products/snyk-code/cli-for-snyk-code/snyk-code-cli-results.md)
    * [Snyk Code CLI 결과 필터링 및 내보내기](products/snyk-code/cli-for-snyk-code/advanced-snyk-code-cli-usage.md)
  * [배포 옵션](products/snyk-code/deployment-options/README.md)
...
* [Snyk Container](products/snyk-container/README.md)
  ...
  * [Snyk Container 보안 기본 사항](products/snyk-container/snyk-container-security-basics/README.md)
    * [Snyk Container 작동 방식](products/snyk-container/snyk-container-security-basics/how-snyk-container-works.md)
    * [지원되는 운영체제 배포판](products/snyk-container/snyk-container-security-basics/supported-operating-system-distributions.md)
    * [Linux 취약점 심각도 이해](products/snyk-container/snyk-container-security-basics/understanding-linux-vulnerability-severity.md)
  * [컨테이너 보안을 위한 Snyk CLI](products/snyk-container/snyk-cli-for-container-security/README.md)
    * [Snyk Container CLI 결과 이해](products/snyk-container/snyk-cli-for-container-security/understanding-snyk-container-cli-results.md)
  ...
  * [Snyk Container UI 둘러보기](products/snyk-container/getting-around-the-snyk-container-ui/README.md)
    ...
    * [이미지 레이어 정보](products/snyk-container/getting-around-the-snyk-container-ui/image-layer-information.md)
  * [Dockerfile 스캔](products/snyk-container/scan-your-dockerfile/README.md)
    * [labels를 사용하여 Dockerfile과 이미지를 자동으로 연결](products/snyk-container/scan-your-dockerfile/automatically-link-between-dockerfile-and-images-using-labels.md)
    * [Dockerfile에서 취약한 기본 이미지 감지](products/snyk-container/scan-your-dockerfile/detect-vulnerable-bases-images-from-dockerfile.md)
    * [Dockerfile의 취약한 기본 이미지를 수정하기 위한 PR 열기](products/snyk-container/scan-your-dockerfile/open-pull-requests-to-fix-vulnerable-base-images-in-your-dockerfile.md)
    * [Dockerfile 명령어란?](products/snyk-container/scan-your-dockerfile/what-is-a-dockerfile-instruction.md)
    * [Dockerfile 분석을 위해 지원되는 저장소](products/snyk-container/scan-your-dockerfile/supported-repos-for-dockerfile-analysis.md)
    * [Dockerfile 분석을 위한 전제 조건](products/snyk-container/scan-your-dockerfile/prerequisites-for-dockerfile-analysis.md)
    * [Dockerfile 추가 및 기본 이미지 테스트](products/snyk-container/scan-your-dockerfile/adding-your-dockerfile-and-test-your-base-image.md)
  * [자체 호스팅된 컨테이너 레지스트리 통합](products/snyk-container/integrate-self-hosted-container-registries/README.md)
    * [자체 호스팅된 컨테이너 레지스트리에 대한 Snyk 통합](products/snyk-container/integrate-self-hosted-container-registries/snyk-integration-to-self-hosted-container-registries.md)
    * [중개 ECR 통합을 위한 Container Registry Agent 설정](products/snyk-container/integrate-self-hosted-container-registries/setting-up-the-container-registry-agent-for-a-brokered-ecr-integration.md)
  * [이미지 스캔 information library](products/snyk-container/image-scanning-library/README.md)
    * [ACR 이미지 스캔](products/snyk-container/image-scanning-library/acr-image-scanning/README.md)
      * [ACR을 이용한 컨테이너 보안: 통합 및 테스트](products/snyk-container/image-scanning-library/acr-image-scanning/container-security-with-acr-integrate-and-test.md)
      * [ACR 통합 구성](products/snyk-container/image-scanning-library/acr-image-scanning/configure-integration-for-acr.md)
      * [ACR에서 Snyk 이미지 추가](products/snyk-container/image-scanning-library/acr-image-scanning/add-images-to-snyk-from-acr.md)
    * [GCR 이미지 스캔](products/snyk-container/image-scanning-library/gcr-image-scanning/README.md)
      * [GCR을 이용한 컨테이너 보안](products/snyk-container/image-scanning-library/gcr-image-scanning/container-security-with-gcr.md)
    ...
    * [DigitalOcean 이미지 스캔](products/snyk-container/image-scanning-library/digitalocean-image-scanning/README.md)
      * [DigitalOcean 통합을 이용한 컨테이너 보안](products/snyk-container/image-scanning-library/digitalocean-image-scanning/container-security-with-digitalocean-integration.md)
      * [Snyk에서 DigitalOcean 컨테이너 이미지 스캔](products/snyk-container/image-scanning-library/digitalocean-image-scanning/scan-container-images-from-digitalocean-in-snyk.md)
    * [Docker Hub 이미지 스캔](products/snyk-container/image-scanning-library/docker-hub-image-scanning/README.md)
    ...
    * [ECR 이미지 스캔](products/snyk-container/image-scanning-library/ecr-image-scanning/README.md)
      * [Amazon Elastic Container Registry (ECR)를 사용한 컨테이너 보안: 통합 및 테스트](products/snyk-container/image-scanning-library/ecr-image-scanning/container-security-with-amazon-elastic-container-registry-ecr-integrate-and-test.md)
      * [처음으로 ECR(Amazon Elastic Container Registry)에 액세스할 수 있는 사용 권한 사용](products/snyk-container/image-scanning-library/ecr-image-scanning/enable-permissions-to-access-amazon-elastic-container-registry-ecr-for-the-first-time.md)
    ...
    * [GitHub container registry 이미지 스캔](products/snyk-container/image-scanning-library/github-container-registry-image-scanning/README.md)
      * [GitHub container registry 통합을 이용한 컨테이너 보안](products/snyk-container/image-scanning-library/github-container-registry-image-scanning/container-security-with-github-container-registry-integration.md)
      * [Snyk에서 GitHub container registry 컨테이너 이미지 스캔](products/snyk-container/image-scanning-library/github-container-registry-image-scanning/scan-container-images-from-github-container-registry-in-snyk.md)
    * [GitLab container registry 이미지 스캔](products/snyk-container/image-scanning-library/gitlab-container-registry-image-scanning/README.md)
      * [GitLab container registry 통합을 이용한 컨테이너 보안](products/snyk-container/image-scanning-library/gitlab-container-registry-image-scanning/container-security-with-gitlab-container-registry-integration.md)
    ...
    * [Harbor image scanning](products/snyk-container/image-scanning-library/harbor-image-scanning/README.md)
      * [Harbor 통합을 이용한 컨테이너 보안](products/snyk-container/image-scanning-library/harbor-image-scanning/container-security-with-harbor-integration.md)
    ...
    * [JFrog Artifactory 이미지 스캔](products/snyk-container/image-scanning-library/jfrog-artifactory-image-scanning/README.md)
      ...
      * [Snyk에 Artifactory 이미지 추가](products/snyk-container/image-scanning-library/jfrog-artifactory-image-scanning/add-artifactory-images-to-snyk.md)
    * [Kubernetes 워크로드 및 이미지 스캔](products/snyk-container/image-scanning-library/kubernetes-workload-and-image-scanning/README.md)
      ...
      * [Kubernetes 통합 설정 확인](products/snyk-container/image-scanning-library/kubernetes-workload-and-image-scanning/viewing-your-kubernetes-integration-settings.md)
...
* [Snyk Infrastructure as Code](products/snyk-infrastructure-as-code/README.md)
  ...
  * [CloudFormation 파일 스캔](products/snyk-infrastructure-as-code/scan-cloudformation-files/README.md)
    ...
    * [브로커를 사용하여 CloudFormation 구성 파일 탐지](products/snyk-infrastructure-as-code/scan-cloudformation-files/detecting-cloudformation-configuration-files-using-a-broker.md)
  * [Kubernetes 구성 파일 스캔](products/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/README.md)
  ...
  * [Infrastructure as Code용 Snyk CLI](products/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/README.md)
    ...
    * [CLI를 이용하여 Kustomize 파일 테스트 진행](products/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-kustomize-files-with-our-cli-tool.md)
    * [CLI 도구를 사용하여 Helm Charts 테스트](products/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-helm-charts-with-our-cli-tool.md)
    ...
    * [CLI Output 이해](products/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-configuration-scan-issues.md)
  * [IaC 기능들](products/snyk-infrastructure-as-code/iac-functions/README.md)
    * [Infrastructure as Code 이슈 보기](products/snyk-infrastructure-as-code/iac-functions/view-infrastructure-as-code-issues.md)

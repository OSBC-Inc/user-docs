...
* GitHub와 같은 지원되는 [소스 코드 관리 시스템](../../features/integrations/git-repository-scm-integrations/)에서 오픈소스 패키지를 사용하는 프로젝트가 존재해야 합니다.
* Java와 같은 지원되는 [언어 및 패키지 매니저](../../products/snyk-open-source/language-and-package-manager-support/)를 사용해야 합니다.

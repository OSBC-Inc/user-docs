...
모든 SCM 통합 기능을 동시에 구현하려고 하면 [SDLC](https://snyk.io/learn/secure-sdlc/)에 문제가 발생하여 개발 성능이 저하될 위험이 있습니다.
...
SCM이 조직에 이미 구성되어 있는지 확인하려면 **Integrations** 탭으로 이동합니다. 통합된 SCM은 **Configured**로 표시됩니다.
